...
class TableFunction : public Operator
{
   ...
   std::vector<uint64_t>::const_iterator tableIter,tableLimit;
   ...
   public:
   /// Constructor
   TableFunction(Operator* input,Runtime& runtime,uint64_t id,const std::string& name,const std::vector<FunctionArgument>& inputArgs,const std::vector<Register*>& outputVars,double expectedOutputCardinality);
   /// Destructor
   ~TableFunction();
