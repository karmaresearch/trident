...
private:
    ...
    /// Patterns used to construct the output graph. I store them here,
    // just in case I want to finish implementing the CONSTRUCT later on
    PatternGroup constructPatterns;
    /// The pattern
    ...
    void parseProjection(PatternGroup &group);
