...
//---------------------------------------------------------------------------
NestedLoopFilter::NestedLoopFilter(Operator* input,Register* filter,const std::vector<uint64_t>& values,double expectedOutputCardinality)
...
//---------------------------------------------------------------------------
uint64_t NestedLoopFilter::first()
...
//---------------------------------------------------------------------------
uint64_t NestedLoopFilter::next()
