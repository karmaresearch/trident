...
//---------------------------------------------------------------------------
TemporaryDictionary::TemporaryDictionary(DBLayer& dict)
...
//---------------------------------------------------------------------------
bool TemporaryDictionary::lookup(const std::string& text,Type::ID type,unsigned subType, uint64_t& id)
...
//---------------------------------------------------------------------------
bool TemporaryDictionary::lookupById(uint64_t id,const char*& start,const char*& stop,Type::ID& type,unsigned& subType)
