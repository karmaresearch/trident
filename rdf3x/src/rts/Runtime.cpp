...
//---------------------------------------------------------------------------
Runtime::Runtime(DBLayer& db,/*DifferentialIndex* diff,*/TemporaryDictionary* temporaryDictionary, QueryDict *queryDict)
   : db(db),/*diff(diff),*/temporaryDictionary(temporaryDictionary), queryDict(queryDict)
   // Constructor
{
}
//---------------------------------------------------------------------------
